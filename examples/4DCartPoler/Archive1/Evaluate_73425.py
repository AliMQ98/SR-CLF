...
IBEX_VERIFIER_TIMEOUT_SECONDS = 3.0  # per box; clean margins escalate to 2x, then 3x
...
ROA_COVERAGE_WEIGHT = 10.0     # per rollout x0 outside the certified {V < c*}
        ...
        if (
            ...
            try:
                ...
                if np.isfinite(ibex_result.margin_max):
                    report["ibex_penalty"] = 10 * SHGO_MARGIN_WEIGHT * max(
