...
IBEX_VERIFIER_TIMEOUT_SECONDS = 20.0  # per box; clean margins escalate to 2x, then 3x
IBEX_VERIFIER_VERBOSE = False #True

# --- numerical verifier (de/de1220/cmaes/shgo) ---
NUMERICAL_VERIFIER = "de" #None  # options: "shgo", "cmaes", "de", "de1220", None
...
PYGMO_VERIFY_LOCAL_SAMPLES = 450#3000#3000
